# Generated by Django 2.1.2 on 2018-11-02 07:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cus_name', models.CharField(blank=True, max_length=40, null=True)),
                ('cus_phno', models.IntegerField(blank=True, null=True)),
                ('cus_add', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
                'db_table': 'customer',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Stats',
            fields=[
                ('pay', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='myapp.Payment')),
            ],
            options={
                'db_table': 'stats',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Views',
            fields=[
                ('cus', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='myapp.Customer')),
            ],
            options={
                'db_table': 'views',
                'managed': False,
